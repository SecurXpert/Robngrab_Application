...
const PaymentPendingModal = ({ paymentData, onClose }) => {
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      ...
      <div className="px-6 space-y-4 pb-6 overflow-y-auto flex-1">
        ...
        <div className="  bg-[#FEFCE8] border border-[#FFF085] rounded-xl p-5 flex items-start gap-3">
        
          <div>
            <p className="text-[#733E0A] font-family-inter font-weight-500 mb-1">Payment Pending</p>
            <p className="text-[#A65F00] text-sm">The payment is being processed. This usually takes 1-3 business days for bank transfers.</p>
          </div>
        </div>
...
const DetailItem = ({ label, value, valueClassName = "" }) => (
  <div>
    <p className="text-[#4A5565] text-sm font-medium mb-1 font-family-inter font-weight-500 tracking-wider">{label}</p>
