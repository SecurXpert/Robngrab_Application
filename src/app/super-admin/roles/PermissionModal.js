...
import { FaCheck, FaShieldAlt, FaUsers, FaTimes } from "react-icons/fa";
      ...
      <div className="max-w-xl bg-white rounded-xl shadow-xl  w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="border-b border-gray-200 p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              <div
                className={`w-12 h-12 rounded-xl border-2 ${role.iconColor} bg-white flex items-center justify-center shadow-sm`}
              >
            ...
            <button
              onClick={onClose}
              className="text-gray-400 hover:text-gray-600 shadow-md rounded-full p-2 transition-colors"
            >
              <FaTimes size={20} />
            </button>
          </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[60vh]">
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3 ">
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("userManagement", "create")
                    }
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("userManagement", "edit")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("userManagement", "delete")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("userManagement", "view")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("vendorManagement", "create")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("vendorManagement", "edit")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("vendorManagement", "delete")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("vendorManagement", "fullAccess")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("financial", "viewData")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("financial", "manageSubscriptions")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("financial", "generateReports")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("financial", "approvePayments")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("system", "settings")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("system", "securityLogs")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
                ...
                <label className="flex items-center gap-2 cursor-pointer relative">
                  <input
                    ...
                    onChange={() =>
                      handlePermissionChange("system", "technicalSupport")
                    }
                    className="w-4 h-4 appearance-none rounded border-2 border-gray-300 focus:ring-blue-500 checked:bg-blue-600 checked:border-blue-600 peer"
                  />
                  <FaCheck className="w-4 h-4 absolute pointer-events-none hidden peer-checked:block text-white" />
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600">
                Changes will affect all {role.usersAssigned} users currently
