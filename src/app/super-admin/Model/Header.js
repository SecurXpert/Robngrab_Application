    ...
    <nav className="fixed top-0 left-0 right-0 bg-white shadow-sm border-b border-gray-200 px-4 sm:px-6 py-2 sm:py-3 z-50">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Link href="/super-admin/settings" className="flex items-center gap-2 sm:gap-3 pl-2 sm:pl-4 border-l border-gray-200 cursor-pointer hover:opacity-80 transition-opacity no-underline text-current">
