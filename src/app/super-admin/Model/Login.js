...
export default function CandiateAuth() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Login attempt:', { email, password, role, rememberMFA });
    ...
    switch (role) {
      case 'super-admin':
        ...
        break;
      case 'prime-admin':
        router.push('/Prime-admin/Dashboard');
        break;
      case 'creator':
        ...
        <div className="w-full max-w-full lg:max-w-[38rem]">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-4 mb-8">
              ...
              <Link href="/super-admin/signup" className="w-full px-6 py-3 rounded-lg font-medium transition-all duration-200 cursor-pointer border-[#0163D7] text-base text-center flex items-center justify-center no-underline text-[#0163D7] border border-[#0163D7] hover:bg-gray-200">
                Signup
              </Link>
            </div>
          </form>
