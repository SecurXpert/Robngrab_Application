              ...
              <div className="relative inline-block w-full max-w-4xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg z-50">
                <div className="px-6 py-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-semibold text-gray-900">Franchise Full History</h3>
                    <button
                      onClick={() => setIsHistoryModalOpen(false)}
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto">
                    {[
                      { date: '2024-01-15 10:30 AM', action: 'Franchise profile updated', details: 'Updated contact information and subscription plan', status: 'success' },
                      { date: '2024-01-14 03:45 PM', action: 'New recruiter added', details: 'John Smith joined as Senior Recruiter', status: 'info' },
                      { date: '2024-01-13 11:20 AM', action: 'Subscription renewed', details: 'Premium Plan renewed for 1 year - $5,000', status: 'success' },
                      { date: '2024-01-12 02:15 PM', action: 'Payment processed', details: 'Monthly subscription fee $500 charged', status: 'success' },
                      { date: '2024-01-11 09:30 AM', action: 'Franchise status changed', details: 'Status changed from Pending to Active', status: 'warning' },
                      { date: '2024-01-10 04:20 PM', action: 'New franchise created', details: 'Franchise account created and setup initiated', status: 'info' },
                      { date: '2024-01-09 02:00 PM', action: 'Application submitted', details: 'Initial franchise application received', status: 'info' },
                      { date: '2024-01-08 11:15 AM', action: 'Initial contact', details: 'First inquiry about franchise opportunities', status: 'info' }
                    ].map((event, index) => (
                  ...
                  <div className="flex justify-between items-center mt-6 pt-6 border-t border-gray-200">
                    <div className="flex space-x-3">
                      <button className="px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium flex items-center">
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        Export History
