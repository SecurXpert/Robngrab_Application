...
export default function BrowseCategories() {
  const categories = [
    {
      name: 'Agriculture',
      icon: '/Assets/Category-icons/Agriculture.svg',
      jobs: 1254
    },
    {
      name: 'Metal Production',
      icon: '/Assets/Category-icons/Metal-production.svg',
      jobs: 816
    },
    {
      name: 'Commerce',
      icon: '/Assets/Category-icons/Commerce.svg',
      jobs: 2082
    },
    {
      name: 'Construction',
      icon: '/Assets/Category-icons/Construction.svg',
      jobs: 1520
    },
    {
      name: 'Hotels & Tourism',
      icon: '/Assets/Category-icons/Hotels-tourism.svg',
      jobs: 1022
    },
    {
      name: 'Education',
      icon: '/Assets/Category-icons/Education.svg',
      jobs: 1496
    },
    {
      name: 'Financial Services',
      icon: '/Assets/Category-icons/Financial-services.svg',
      jobs: 1529
    },
    {
      name: 'Transport',
      icon: '/Assets/Category-icons/Transport.svg',
      jobs: 1244
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="hidden sm:block">
            ...
            {/* Third Row - 2 cards */}
            <div className="grid grid-cols-2 gap-4 sm:gap-6 max-w-[38rem] mx-auto">
