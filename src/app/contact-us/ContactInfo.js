      ...
      <div className="relative z-10 w-full px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            <p className="font-semibold text-gray-700 text-sm uppercase tracking-wide mb-1">Contact Info</p>
          ...
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-12">
            <div className="text-center md:text-left">
              <p className="font-semibold text-sm uppercase tracking-wide text-gray-700 mb-1">Email Address</p>
            ...
            <div className="text-center md:text-left">
              <p className="font-semibold text-sm uppercase tracking-wide text-gray-700 mb-1">Number</p>
