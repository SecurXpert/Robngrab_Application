      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-2 lg:pr-8">
            <div className="mb-8">
              <div className="flex items-center mb-6">
                ...
                <img src="/assets/home/logo.png" alt="RobNGrab" className="h-12 w-auto" />
              </div>
          ...
          <div className="lg:col-span-1">
            <h4 className="font-bold text-blue-600 mb-6 text-sm uppercase tracking-wider">Quick Link</h4>
          ...
          {/* Candidate */}
          <div className="lg:col-span-1">
            <h4 className="font-bold text-blue-600 mb-6 text-sm uppercase tracking-wider">Candidate</h4>
            <nav className="flex flex-col space-y-3">
              <a href="#" className="group text-slate-600 text-sm py-2  hover:text-blue-600 transition-all duration-300 flex items-center rounded-lg relative">
          ...
          {/* Employers */}
          <div className="lg:col-span-1">
            <h4 className="font-bold text-blue-600 mb-6 text-sm uppercase tracking-wider">Employers</h4>
            <nav className="flex flex-col space-y-3">
              <a href="#" className="group text-slate-600 text-sm py-2  hover:text-blue-600 transition-all duration-300 flex items-center rounded-lg relative">
          ...
          {/* Support */}
          <div className="lg:col-span-1">
            <h4 className="font-bold text-blue-600 mb-6 text-sm uppercase tracking-wider">Support</h4>
            <nav className="flex flex-col space-y-3">
              <a href="#" className="group text-slate-600 text-sm py-2  hover:text-blue-600 transition-all duration-300 flex items-center rounded-lg relative">
