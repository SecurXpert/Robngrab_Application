      ...
      <div className="max-w-6xl lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3 lg:gap-5 flex-shrink-0">
            <Link
              href="/signup"
              className="px-4 lg:px-6 py-2.5 text-gray-700 border-2 border-gray-200 rounded-lg font-semibold text-sm lg:text-base bg-white transition-all hover:bg-slate-50 hover:border-gray-300 hover:-translate-y-0.5 hover:shadow-xl"
            >
              Sign Up
            </Link>
