        ...
        <div className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {visibleTestimonials.map((testimonial) => (
              ...
              >
                ...
                {/* Second Row - Empty Spacer */}
                <div className="h-2"></div>

                {/* Third Row - Photo and Icon */}
                <div className="flex items-center justify-between">
                  ...
                  {/* Quote Icon */}
                  <div className="text-blue-200 rotate-180">
                    <FaQuoteRight className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>
                </div>
              </div>
            ))}
          ...
          {currentIndex > 0 && (
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 sm:-translate-x-4 bg-white p-2 sm:p-3 shadow-lg hover:shadow-xl transition-shadow duration-300"
              aria-label="Previous testimonials"
            >
              <FiArrowLeft className="w-4 h-4 sm:w-6 sm:h-6 text-blue-600" />
            </button>
          )}
          ...
          {currentIndex < testimonials.length - 3 && (
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 sm:translate-x-4 bg-white p-2 sm:p-3 shadow-lg hover:shadow-xl transition-shadow duration-300"
              aria-label="Next testimonials"
            >
              <FiArrowRight className="w-4 h-4 sm:w-6 sm:h-6 text-blue-600" />
            </button>
          )}
        </div>
