...
import InterviewDetails from '@/app/candidate/interview-management/Model/InterviewDetails';
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${interview.status === 'confirmed'
