...
const HeaderNavigation = () => {
  ...
  const menuItems = [
    ...
    { icon: FiCalendar, label: 'Interview Management', active: false, path: '/candidate/interview-management' },
        ...
        <div className="flex items-center space-x-2">
          {menuItems.map((item, index) => (
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all ${item.active
