  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        <div className="fixed left-0 top-0 h-screen bg-white border-r border-gray-200 transition-all duration-300 z-40 w-72">
          {/* Logo */}
          <div className="flex items-center gap-2 p-4 border-b border-gray-200 h-16">
            <Image 
          ...
          <div className="w-72 h-[calc(100vh-4rem)] flex flex-col">
            {/* Filter Button */}
            {/* <div className="px-4 py-4 border-b border-gray-200">
              <button
                onClick={() => setShowFilters(!showFilters)}
                className="flex items-center w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
              >
